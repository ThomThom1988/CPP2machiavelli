...
//
//void Server::consume_command(Game *game) // runs in its own thread
//{
//	try {
//		while (running) {
...
//					else if (game->getCurrentPlayer() != clientInfo)
//					{
//						client << "De tegenstander is aan de beurt.\r\n";
//					}
...
////}
//
//void Server::handle_client(Socket client, Game *game) // this function runs in a separate thread
//{
//	try {
...
//	//krijg niet aan praat
//	//all_threads.emplace_back(std::mem_fn(&Server::consume_command),std::ref(game));
//
...
//
//				//krijg niet aan praat
//				//all_threads.emplace_back(std::mem_fn(&Server::handle_client),(move(std::ref(client))), std::ref(game));
//			});
